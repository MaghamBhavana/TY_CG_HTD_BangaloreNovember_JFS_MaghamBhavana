...
public class CompanyController {
	...
	public CompanyResponse viewCompany(@PathVariable("companyId") int companyId) {
		CompanyResponse companyResponse = new CompanyResponse();
	...
	public CompanyResponse deleteCompany(@PathVariable("companyId") int companyId) {
		CompanyResponse companyResponse = new CompanyResponse();
	...
	public CompanyResponse updateCompany(@PathVariable("companyId") int companyId, @RequestBody Company company) {
