	...
	public static void orderLogic() {
		...
		while (true) {
			...
			case 1:
				...
				HashMap<Integer, OrderBean> orders = service.getAllOrders();
				int orderNo = orders.size() + 1;
				boolean check = service.addOrder(orderNo, bean);
				if (check) {
			...
			case 2:
				try {
					...
					Entry<Integer, OrderBean> order = service.getOrder(orderNo1);
					if (order != null) {
						System.out.println("Hi!! Here is your data....");
						System.out.println("*************************************************************");
						System.out.println("Order number= " + order.getKey());
						System.out.println("Customer id= " + order.getValue().getCustomerId());
						System.out.println("Product id= " + order.getValue().getProductId());
						System.out.println("Haulier id= " + order.getValue().getHaulierId());
						System.out.println("Delivery date= " + order.getValue().getDeliveryDate());
						System.out.println("Delivery day= " + order.getValue().getDeliveryDay());
						System.out.println("Quantity= " + order.getValue().getQuantity());
						System.out.println("--------------------------------------");
					} else {
			...
			case 3:
				HashMap<Integer, OrderBean> order = service.getAllOrders();
				if (order == null) {
					System.err.println("Oops, No Records Found.");
					System.out.println("----------------------------");
				} else {
					for (Entry<Integer, OrderBean> orderBean : order.entrySet()) {
						System.out.println("Hi!! Here is your data....");
						System.out.println("*************************************************************");
						System.out.println("Order number= " + orderBean.getKey());
						System.out.println("Customer id= " + orderBean.getValue().getCustomerId());
						System.out.println("Product id= " + orderBean.getValue().getProductId());
						System.out.println("Haulier id= " + orderBean.getValue().getHaulierId());
						System.out.println("Delivery date= " + orderBean.getValue().getDeliveryDate());
						System.out.println("Delivery day= " + orderBean.getValue().getDeliveryDay());
						System.out.println("Quantity= " + orderBean.getValue().getQuantity());
						System.out.println("--------------------------------------");
					}
				}
				break;
			...
			case 4:
				...
				try {
					...
					Entry<Integer, OrderBean> order1 = service.getOrder(orderNo1);
					boolean isFound = false;
					if (order1 != null) {
						isFound = true;
						bean = order1.getValue();
					}
			...
			case 5:
				...
				try {
					...
					Entry<Integer, OrderBean> orderId = service.getOrder(deleteId);
					boolean isFound = false;
					if (orderId != null) {
						isFound = true;
						bean = orderId.getValue();
					}
					if (isFound) {
