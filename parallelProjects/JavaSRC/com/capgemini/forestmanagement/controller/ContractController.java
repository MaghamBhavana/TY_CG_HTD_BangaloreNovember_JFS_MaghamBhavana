	...
	public static void contractorLogic() {
		...
		while (true) {
			...
			case 1:
				...
				HashMap<Integer, ContractBean> contracts = service.getAllContracts();
				int contractNo = contracts.size() + 1;
				boolean check = service.addContract(contractNo, bean);
				if (check) {
			...
			case 2:
				try {
					...
					Entry<Integer, ContractBean> contract = service.getContract(contractNo1);
					if (contract != null) {
						System.out.println("Hi!! Here is your data....");
						System.out.println("*************************************************************");
						System.out.println("Contract number= " + contract.getKey());
						System.out.println("Customer id= " + contract.getValue().getCustomerId());
						System.out.println("Product id= " + contract.getValue().getProductId());
						System.out.println("Haulier id= " + contract.getValue().getHaulierId());
						System.out.println("Delivery date= " + contract.getValue().getDeliveryDate());
						System.out.println("Delivery day= " + contract.getValue().getDeliveryDay());
						System.out.println("Quantity= " + contract.getValue().getQuantity());
						System.out.println("--------------------------------------");
					} else {
			...
			case 3:
				HashMap<Integer, ContractBean> contract1 = service.getAllContracts();
				if (contract1 == null) {
					...
					for (Entry<Integer, ContractBean> contractBean : contract1.entrySet()) {
						System.out.println("Hi!! Here is your data....");
						System.out.println("*************************************************************");
						System.out.println("Contract number= " + contractBean.getKey());
						...
						System.out.println("Delivery day= " + contractBean.getValue().getDeliveryDay());
			...
			case 4:
				...
				try {
					...
					Entry<Integer, ContractBean> contract = service.getContract(contractNo2);
					boolean isFound = false;
					if (contract != null) {
						isFound = true;
						bean = contract.getValue();
					}
			...
			case 5:
				...
				try {
					...
					Entry<Integer, ContractBean> cont = service.getContract(deleteId);
					boolean isFound = false;
					if (cont != null) {
						isFound = true;
						bean = cont.getValue();
