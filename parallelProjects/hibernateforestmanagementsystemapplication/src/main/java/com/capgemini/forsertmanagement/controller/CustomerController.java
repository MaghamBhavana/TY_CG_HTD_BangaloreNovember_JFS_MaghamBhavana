		...
		while (true) {
			...
			case 1:// add customer
				...
				boolean check = service.addCustomer(bean);
					...
					if (check) {
						System.out.println("Good, You successfully added the details of customer");
						System.out.println("--------------------------------------");
					} else {
			...
			case 2:// get customer
				...
				try {
					...
					if (customer != null) {
						...
						System.out.println("Street address1= " + customer.getAddress1());
						System.out.println("Street address2= " + customer.getAddress2());
			...
			case 3:// get all customers
					...
					if (customer1 == null) {
						...
						for (CustomerBean customerBean : customer1) {
							...
							System.out.println("Street address1= " + customerBean.getAddress1());
							System.out.println("Street address2= " + customerBean.getAddress2());
